...
>
    <g>
        <g>
            <g>
                <path
                    d="M187.737,358.407c12.237,0,20.872-7.646,24.047-12.16c2.679-3.814,1.766-9.011-2.005-11.75
            ...
            c-2.731-3.78-7.996-4.676-11.827-1.988c-3.857,2.714-4.787,8.038-2.074,11.887C166.864,350.761,175.5,358.407,187.737,358.407z"
                />
                <path
                    d="M179.204,119.474c-32.939,0-59.733,26.795-59.733,59.733s26.795,59.733,59.733,59.733
            ...
            c0-23.526,19.14-42.667,42.667-42.667c23.526,0,42.667,19.14,42.667,42.667C221.87,202.734,202.73,221.874,179.204,221.874z"
                />
                <path
                    d="M266.158,336.331c-0.154,0.205-3.831,5.009-10.155,5.009c-6.221,0-9.882-4.642-10.146-4.992
            ...
            s20.872-7.646,24.047-12.16c2.679-3.814,1.766-9.011-2.005-11.75C274.265,331.749,268.957,332.602,266.158,336.331z"
                />
                <path
                    d="M76.889,212.129c-0.666,4.668,2.577,8.994,7.236,9.66c4.651,0.631,8.986-2.577,9.66-7.236
            ...
            c-2.893,1.451-4.719,4.403-4.719,7.637c0,69.487,17.229,104.747,17.672,105.574C69.038,114.516,85.004,155.314,76.889,212.129z"
                />
                <path
                    d="M294.873,240.374c-3.934-2.628-9.225-1.562-11.836,2.364l-27.034,40.55l-27.034-40.55
            ...
            c2.85,0,5.513-1.425,7.1-3.797l34.133-51.2C299.848,248.285,298.79,242.985,294.873,240.374z"
                />
                <path
                    d="M179.204,162.141c-9.412,0-17.067,7.654-17.067,17.067s7.654,17.067,17.067,17.067c9.412,0,17.067-7.654,17.067-17.067
            S188.616,162.141,179.204,162.141z"
                />
                <path
                    d="M314.184,388.914c2.679-3.814,1.766-9.011-2.005-11.75c-3.789-2.748-9.088-1.886-11.887,1.835
            ...
            c-3.857,2.705-4.787,8.03-2.074,11.887c3.174,4.514,11.81,12.16,24.047,12.16C302.374,401.074,311.009,393.428,314.184,388.914z"
                />
                <path
                    d="M392.537,179.207c0-32.939-26.795-59.733-59.733-59.733s-59.733,26.795-59.733,59.733s26.795,59.733,59.733,59.733
            ...
            c23.526,0,42.667,19.14,42.667,42.667C375.47,202.734,356.33,221.874,332.804,221.874z"
                />
                <path
                    d="M433.531,239.111c-1.109,0.213-27.264,5.743-46.421,35.123c-21.692,33.289-25.566,82.321-11.511,145.749
            ...
            H307.204z"
                />
                <path
                    d="M213.337,401.074c12.237,0,20.873-7.646,24.047-12.16c2.68-3.814,1.766-9.011-2.005-11.75
            ...
            c-2.731-3.78-7.996-4.676-11.827-1.988c-3.857,2.705-4.787,8.03-2.074,11.887C192.464,393.428,201.1,401.074,213.337,401.074z"
                />
                <path
                    d="M332.804,162.141c-9.412,0-17.067,7.654-17.067,17.067s7.654,17.067,17.067,17.067s17.067-7.654,17.067-17.067
            S342.216,162.141,332.804,162.141z"
                />
                <path
                    d="M256.004,443.741c12.237,0,20.872-7.646,24.047-12.16c2.679-3.814,1.766-9.011-2.005-11.75
            ...
            c-2.731-3.78-7.996-4.676-11.827-1.988c-3.857,2.714-4.787,8.03-2.074,11.887C235.131,436.095,243.767,443.741,256.004,443.741z"
                />
                <path
                    d="M348.317,346.247c2.679-3.814,1.766-9.011-2.005-11.75c-3.78-2.748-9.079-1.894-11.887,1.835
            c-0.154,0.205-3.831,5.009-10.155,5.009c-6.221,0-9.882-4.642-10.146-4.992c-2.731-3.78-8.004-4.676-11.827-1.988
    ...
    return (
        <header>
            <div className="header-content">
                ...
                <nav className="menu">
                    <ul>
                        {headerLinks.map((hl) => <li key={hl.title}>
                            <Link to={hl.href} aria-label={`Переход к странице ${hl.title}`}>
                                {hl.title}
                            </Link>
                        </li>)}
                    </ul>
